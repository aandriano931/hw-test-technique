 ...
 */
final class Version20240310210602_ChangeToIntegerPrimaryKeyForJobOffer extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE job_offer (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, france_travail_id VARCHAR(10) NOT NULL, label VARCHAR(255) DEFAULT NULL, description CLOB DEFAULT NULL, company_name VARCHAR(255) DEFAULT NULL, contract_type VARCHAR(10) DEFAULT NULL, apply_url VARCHAR(255) DEFAULT NULL, salary VARCHAR(255) DEFAULT NULL, activity_sector VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
